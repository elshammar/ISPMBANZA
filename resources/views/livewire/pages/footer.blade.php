<div class="bg-gray-900">
    <div class="flex justify-between border-b py-3 px-8 lg:px-40">
        ...
        {{-- liens reseaux et bouton contact --}}
        <div class="flex ">
            <div class="border-x px-5 hidden  lg:flex items-center justify-center gap-2">
                <div>
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 32 32" class=" ">
            ...
            <div class="px-5 flex justify-center items-center">
                <div class="bg-yellow-500 p-3 font-bold text-white">
                    Nous contacter
                </div>
            </div>
        </div>
    ...
    {{-- Code grid footer --}}
    <div class="lg:px-40 px-8 py-20 grid lg:grid-cols-12 gap-5">
        <div class="col-span-4">
            <div class="text-2xl font-bold text-white border-b border-white pb-5 w-32">
                Adresse
            </div>
            <div class="flex gap-1 pt-5 text-white">
                <div>
        ...
        <div class=" col-span-2 pl-2">
            <div class="text-2xl font-bold text-white border-b border-white pb-5 w-20">
                Menu
            </div>
        ...
        {{-- Code Gallerie footer --}}
        <div class="col-span-4 lg:pl-8">
            <div class="text-2xl font-bold text-white border-b border-white pb-5 w-32">
                Gallerie
            </div>
    ...
    {{-- Code copyrihgt --}}
    <div class="border-t border-white py-3 text-center text-white font-bold">
        Copyright © 2021-2024 Systematik Tous droits réservés.
    </div>
</div>
